 ...
 * in the book:<br>
 * if TERMAINAL?(s) then Q[s,None] <- r'<br> should be:<br>
 * if TERMAINAL?(s') then Q[s',None] <- r'<br> so that the correct value for
 * Q[s',a'] is used in the Q[s,a] update rule when a terminal state is
 * reached.<br>
 * <br>
